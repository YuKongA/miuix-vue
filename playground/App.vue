...
const navItems: MiuixNavigationItem[] = [
  { label: 'Home' },
  { label: 'Components' },
  { label: 'Settings' },
]
...
<template>
  <MiuixScaffold class="app">
    <template #top-bar>
      <MiuixTopAppBar title="Home" class="app__bar">
        <template #actions>
    ...
    <div class="app__content">
      ...
      <MiuixCard class="section-card section-card--pad">
        <div class="button-row">
          ...
          <MiuixButton class="grow" type="primary" @click="onSubmit">{{ submitText }}</MiuixButton>
        </div>
        <div class="button-row">
      ...
      <MiuixCard class="section-card section-card--pad">
        <div class="button-row">
          <MiuixButton class="grow" @click="showSnackbar({ message: 'A short snackbar message.' })">
            Show
          </MiuixButton>
          <MiuixButton
            class="grow"
    ...
    <template #fab>
      <MiuixFloatingActionButton
        aria-label="Snackbar"
        @click="showSnackbar({ message: 'Floating action button tapped.' })"
      >
        <span class="app__fab-glyph">+</span>
      </MiuixFloatingActionButton>
    </template>
    ...
    <template #bottom-bar>
      <MiuixNavigationBar v-model="navIndex" :items="navItems">
        <template #icon="{ selected }">
          <span class="app__nav-dot" :class="{ 'app__nav-dot--on': selected }" />
        </template>
      </MiuixNavigationBar>
    </template>
  </MiuixScaffold>
...
.app {
  ...
  // Scaffold body + bars share the surface backdrop behind the cards.
  .m-scaffold__body,
  &__bar,
  .m-navigation-bar {
